export const ENGLISH_SAMPLE = `Agent: Thank you for calling support. How can I help you today?
...
export const ARMENIAN_SAMPLE = `Գործակալ: Բարև ձեզ, շնորհակալություն զանգելու համար։ Ինչպե՞ս կարող եմ օգնել ձեզ:
...
Գործակալ: Շնորհակալություն, Արա։ Կարո՞ղ եք նաև նշել ձեր անձնագրի համարը:
Զանգահարող: Իմ անձնագրի համարն է AM1234567:
Գործակալ: Շատ լավ, հիմա կստուգեմ ձեր հաշիվը։ Մի պահ սպասեք:
Զանգահարող: Լավ, շնորհակալություն:`;
